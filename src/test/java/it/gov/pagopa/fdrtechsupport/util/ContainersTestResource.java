...
public class ContainersTestResource implements QuarkusTestResourceLifecycleManager {
  ...
  public Map<String, String> start() {
    ...
    mockServer =
        new MockServerContainer(DockerImageName.parse("mockserver/mockserver:5.15.0"))
            .withClasspathResourceMapping(
                "mockserver", // directory in test resources
                "/config", // container directory
                BindMode.READ_ONLY)
            .withEnv("MOCKSERVER_INITIALIZATION_JSON_PATH", "/config/*.json");
    mockServer.start();
    ...
    return Map.of(
        ...
        "blob-storage.fdr.connection-string", azuriteConnection,
        "quarkus.rest-client.fdr.url", mockServer.getEndpoint());
  }
